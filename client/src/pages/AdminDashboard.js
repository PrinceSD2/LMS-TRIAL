...
const AdminDashboard = () => {
  ...
  }, [showLeadsSection, qualificationFilter, duplicateFilter]);
                          ...
                          <div className="text-sm">
                            ...
                            <div className="text-xs text-gray-500 mt-1">
                              {lead.duplicateReason === 'both' ? 'Email & Phone' : 
                               lead.duplicateReason === 'email' ? 'Email Match' : 'Phone Match'}
                            </div>
                            {lead.duplicateOf && (
                  ...
                  <div className="bg-gradient-to-br from-teal-50 to-teal-100 p-5 rounded-xl border border-teal-200">
                    <div className="flex items-center mb-4">
                      ...
                      <h4 className="text-lg font-semibold text-gray-800">
                        {selectedLead.lastUpdatedBy && selectedLead.lastUpdatedBy.includes('Agent') ? 
                          `${selectedLead.lastUpdatedBy} Actions & Status` : 
                          'Agent2 Actions & Status'
                        }
                      </h4>
                    </div>
                    <div className="space-y-3">
